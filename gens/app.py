...
from .db import init_database, SampleNotInDB
from .errors import generic_error, missing_files, sample_not_found
...
def register_errors(app):
    ...
    app.register_error_handler(SampleNotInDB, sample_not_found)
